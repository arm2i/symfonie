...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\CompetenceType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\CompetenceType']) ? $this->services['AppBundle\\Form\\CompetenceType'] : ($this->services['AppBundle\\Form\\CompetenceType'] = new \AppBundle\Form\CompetenceType())) && false ?: '_'};
}, 'AppBundle\\Form\\StagiaireType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\StagiaireType']) ? $this->services['AppBundle\\Form\\StagiaireType'] : ($this->services['AppBundle\\Form\\StagiaireType'] = new \AppBundle\Form\StagiaireType())) && false ?: '_'};
